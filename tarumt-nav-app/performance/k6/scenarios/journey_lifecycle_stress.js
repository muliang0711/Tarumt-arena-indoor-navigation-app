import { runCanonicalJourney } from '../lib/presence.js';

export const options = {
  scenarios: {
    journey_lifecycle_stress: {
  ...
  thresholds: {
    ...
    journey_start_ack_latency_ms: ['p(95)<1000'],
    journey_end_ack_latency_ms: ['p(95)<1000'],
  },
};

export default function () {
  runCanonicalJourney({
    label: 'journey-lifecycle-stress',
    updates: 20,
    updateIntervalMs: 25,
    holdMs: 100,
  });
