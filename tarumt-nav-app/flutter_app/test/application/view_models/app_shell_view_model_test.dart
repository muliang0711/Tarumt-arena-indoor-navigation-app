...
void main() {
  ...
  test('can leave the map while resetting the next Navigate entry', () async {
    final viewModel = AppShellViewModel()..openMap();

    viewModel.selectSection(AppSection.liveMap, resetNavigatePage: true);

    expect(viewModel.state.selectedSection, AppSection.liveMap);
    expect(viewModel.state.navigatePage, AppNavigatePage.selectFloor);
