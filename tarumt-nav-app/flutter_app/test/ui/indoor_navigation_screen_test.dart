...
void main() {
  ...
  testWidgets('wires navigation, simulation, zoom, and replay interactions', (
    ...
    await firstFinger.down(pinchCenter - const Offset(40, 0));
    await secondFinger.down(pinchCenter + const Offset(40, 0));
    await tester.pump();
    await firstFinger.moveTo(pinchCenter - const Offset(60, 0));
    await secondFinger.moveTo(pinchCenter + const Offset(60, 0));
    await tester.pump();
    expect(harness.viewModel.state.zoom, closeTo(1.875, 0.001));
...
_ScreenHarness _createHarness({
  required MapRuntimeResourceRepository repository,
}) {
