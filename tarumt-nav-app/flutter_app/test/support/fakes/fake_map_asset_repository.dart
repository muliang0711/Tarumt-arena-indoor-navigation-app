...
final class FakeMapAssetRepository
  ...
  Future<MapRuntimeResources> loadCurrent({
    ...
    final tiledMapJson = await loadTiledMapJson(defaultTiledMapAssetPath);
    final edgeDocumentJson = await loadRouteGraphEdgesJson(
      defaultRouteGraphEdgesAssetPath,
    );
