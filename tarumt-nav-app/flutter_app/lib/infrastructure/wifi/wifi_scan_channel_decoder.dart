...
abstract final class WifiScanChannelDecoder {
  ...
  static WifiScanBatch decodeBatch(Object? raw) {
    ...
    return WifiScanBatch(
      ...
      source: switch (_string(map, 'source')) {
        'active' => WifiScanBatchSource.active,
        'passive' => WifiScanBatchSource.passive,
        'cached' => WifiScanBatchSource.cached,
        final value => throw FormatException(
          'Unknown Wi-Fi scan batch source: $value',
        ),
      },
