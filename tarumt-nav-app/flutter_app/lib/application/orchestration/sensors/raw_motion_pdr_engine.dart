...
final class RawMotionPdrEngine {
  factory RawMotionPdrEngine({
    ...
    double initialHeadingCorrectionDegrees = 0,
    ...
    return RawMotionPdrEngine._(
      clock,
      initialHeadingCorrectionDegrees,
      initialRedMarker,
  ...
  RawMotionPdrEngine._(
    this._clock,
    double initialHeadingCorrectionDegrees,
    ...
    _initialHeadingCorrectionDegrees = normalizeDegrees(
      initialHeadingCorrectionDegrees,
    );
    _headingCorrectionDegrees = _initialHeadingCorrectionDegrees;
  ...
  final Clock _clock;
  late final double _initialHeadingCorrectionDegrees;
  ...
  late double _headingCorrectionDegrees;
