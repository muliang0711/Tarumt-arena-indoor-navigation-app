...
final class IndoorNavigationViewState {
  IndoorNavigationViewState({
    ...
    required this.navigationMapHeadingDegrees,
  ...
  factory IndoorNavigationViewState.initial() => IndoorNavigationViewState(
    ...
    navigation: null,
    navigationMapHeadingDegrees: null,
  ...
  final double? navigationMapHeadingDegrees;
  ...
  double? get navigationDisplayHeadingDegrees => navigationMapHeadingDegrees;
}
