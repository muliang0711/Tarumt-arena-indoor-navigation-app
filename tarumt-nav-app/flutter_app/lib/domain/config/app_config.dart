...
const wifiDebugPanelEnabled = bool.fromEnvironment('WIFI_DEBUG_PANEL');
...
const wifiPositioningThrottleRetryMs = 5000;
const wifiActiveScanCooldownMs = 30000;
const wifiPositioningFreshReadingAgeMs = 15000;
const wifiPositioningFallbackReadingAgeMs = 30000;
const wifiRouteRecalculationDelayMs = 700;
...
const defaultWrongWayRerouteConfig = WrongWayRerouteConfig(
  allowedHeadingDeviationDegrees: 70,
