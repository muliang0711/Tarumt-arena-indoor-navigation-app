...
The dependency direction is deliberate: presentation reads from application models, application reads from integration adapters, and shared contracts sit underneath all three.
