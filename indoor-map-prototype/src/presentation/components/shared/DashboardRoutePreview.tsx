...
export function DashboardRoutePreview() {
  return (
    <View style={styles.routePreviewShell}>
      <Svg width="100%" height="100%" viewBox="0 0 320 150">
        ...
        <Circle cx="252" cy="76" r="10" fill="rgba(34, 197, 94, 0.2)" />
        <Circle cx="252" cy="76" r="6" fill="#22C55E" />
      </Svg>
    </View>
  );
}
