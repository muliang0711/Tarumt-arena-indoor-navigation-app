...
This folder is the source of truth for project-wide UI and component rules.

## Files

- `APP_COLOR_PALETTE.md`: approved app palette, usage intent, and pairing rules
- `COMPONENT_STRUCTURE_RULES.md`: component ownership, splitting, promotion, and placement rules
