...
type MapRouteInstructionCardProps = {
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.copy}>
        <Text style={styles.title}>{cue.message}</Text>
        <View style={styles.nextRow}>
          <Text style={styles.next}>{secondaryMessage(nextCue)}</Text>
        </View>
