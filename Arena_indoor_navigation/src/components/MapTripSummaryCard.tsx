    ...
    <View style={styles.card}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.destination}>Node 4</Text>
        </View>
      ...
      <View style={styles.metrics}>
        <Metric icon="location" color="#1478db" label="Distance" value="24 m" />
        <Metric icon="time" color={colors.green} label="Est. time" value="1 min" />
        <View style={styles.metric}>
      ...
      <View style={styles.nextStep}>
        ...
        <View style={styles.nextCopy}>
          ...
          <Text style={styles.nextTitle}>Go straight 6 m</Text>
        </View>
